...
public partial class DiffLineNumAnalyzer
{
    ...
    public static DiffLinesInfo Analyze(string text, List<TextMarker> allTextMarkers, bool isCombinedDiff, bool isGitWordDiff = false)
    {
        ...
        for (int i = 0; i < lines.Length; i++)
        {
            ...
            else if (i > lines.Length - 4 && !isGitWordDiff && line.StartsWith(GitModule.NoNewLineAtTheEnd))
            {
        ...
        bool IsMovedLine(List<TextMarker> textMarkers, DiffLineInfo meta)
            => textMarkers.Count > 0
                ...
                && (textMarkers.Count <= 2 || !textMarkers[1..^1].All(i => MarkerColorMatch(i, meta.LineType)));
