...
namespace GitUI.CommandsDialogs
{
    partial class RevisionDiffControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            resetFileToToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { resetFileToSelectedToolStripMenuItem, resetFileToParentToolStripMenuItem });
            ...
            // 
            openWithDifftoolToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { secondDiffCaptionMenuItem, firstDiffCaptionMenuItem, firstToSelectedToolStripMenuItem, selectedToLocalToolStripMenuItem, firstToLocalToolStripMenuItem, diffRememberStripSeparator, diffTwoSelectedDifftoolToolStripMenuItem, diffWithRememberedDifftoolToolStripMenuItem, rememberSecondRevDiffToolStripMenuItem, rememberFirstRevDiffToolStripMenuItem });
