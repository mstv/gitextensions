...
namespace GitUITests.CommitInfo
{
    public class RefsFormatterTests
    {
        private readonly IReadOnlyList<string> _refs
            = new List<string> { "r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12", "r13" };
        ...
        [Test]
        public void LimitNotExceededOrNotLimited([Values(1, 9, 10, 11, 12, 13)] int count, [Values(true, false)] bool showAsLinks)
        {
            bool limit = count <= 12;
