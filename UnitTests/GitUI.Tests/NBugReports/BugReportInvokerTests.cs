        ...
        public static IEnumerable TestCases
        {
            get
            {
                ...
                yield return new TestCaseData(new UserExternalOperationException(_context,
                    new ExternalOperationException(new Exception(_messageOuter, new Exception(_messageInner)), _command, _arguments, _directory, _exitCode)),
                    _messageInner,
                ...
                yield return new TestCaseData(new UserExternalOperationException(context: null,
                    new ExternalOperationException(new Exception(_messageInner))),
                    _messageInner,
                    "");
            }
        }
